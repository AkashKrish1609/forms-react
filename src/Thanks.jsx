...
function Thanks(props){
    return (
        <div className={props.hide ? "right-side thanks-div hide" : "right-side thanks-div"}>
            ...
            <h1>Thank you!</h1>
            <p>Thanks for confirming your subscription! We you have fun using our
            platform. If you ever need support, please free feel 
